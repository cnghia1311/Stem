export const LESSONS = [
    ...
    { id: "token-factory", name: "🏭 Bài 7: Khởi Tạo Token", blocks: ["wallet", "erc20-factory", "balance", "transfer", "wrap-eth", "uniswap-v3-lp"] },
    ...
    { id: "poap-event", name: "🎫 Bài 11: Chứng Nhận Sự Kiện", blocks: ["wallet", "erc1155-factory", "update-erc1155", "grant-minter-1155", "qr-generator", "free-claim-1155", "mint-1155", "qr-scanner"] },
